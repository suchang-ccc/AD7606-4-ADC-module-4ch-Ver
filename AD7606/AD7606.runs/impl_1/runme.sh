...
HD_PWD='D:/Programs/FPGA/ZYNQ/AD7606/AD7606.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ad7606_drive.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ad7606_drive.tcl -notrace
