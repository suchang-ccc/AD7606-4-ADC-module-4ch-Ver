...
HD_PWD='D:/Programs/FPGA/ZYNQ/AD7606/AD7606.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ad7606_drive.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ad7606_drive.tcl
